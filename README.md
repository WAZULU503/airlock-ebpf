...
Replay and reconstruction research evolved through progressively
higher-pressure causal degradation phases:

| Phase | Focus |
|---|---|
| Phase 19 | Replay omission pressure |
| Phase 20 | Temporal replay degradation |
| Phase 21 | Composite replay pressure |
| Phase 22 | Replay confidence scoring |
| Phase 23 | Replay collapse surface mapping |

The replay layer operates on bounded reconstruction windows derived
from ExecutionEvent JSONL telemetry.
...
Confidence becomes non-viable when:
- any condition reaches COLLAPSED
- or two or more conditions become CONTESTED simultaneously
